...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    const parsedBgColor = new THREE.Color(rootBgColor);
    const bgVec4 = new THREE.Vector4(parsedBgColor.r, parsedBgColor.g, parsedBgColor.b, 1.0); 
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        this.renderer.setClearColor(parsedBgColor, 1);
...
`;
    ...
    try {
      ...
      console.warn('LiquidEther WebGL initialization failed (context loss or WebGL not supported):', err);
    }
  ...
  return <div ref={mountRef} className={`liquid-ether-container stars-background ${className || ''}`} style={style} />;
}
